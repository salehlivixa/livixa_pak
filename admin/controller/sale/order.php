...
//                $str_arr = explode (",", $product['mac_address']);
                $data['products'][] = array(
                    ...
                    'name' => $product['name'],
                    'model' => $product['model'],
                    'mac_address' => explode(',', $product['mac_address']),
                    'option' => $option_data,
                    'quantity' => $product['quantity'],
            ...
            $data['column_left'] = $this->load->controller('common/column_left');
            $data['footer'] = $this->load->controller('common/footer');
            $data['custom_order_status'] = $order_info['custom_order_status'];
            $data['mac_count'] = $order_info['mac_count'];
            $data['mac_quantity'] = $order_info['mac_quantity'];
