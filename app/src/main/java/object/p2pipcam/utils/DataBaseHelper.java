...
public class DataBaseHelper extends SQLiteOpenHelper {
	 ...
	 * Database Name
	 */
	private static final String DATABASE_NAME = "apacam_database";
	 ...
	 * Table Name
	 */
	private static final String DATABASE_TABLE = "cameralist";// ������б����ݿ�
	private static final String DATABASW_VIDEOPICTURE_TABLE = "cameravidpic";// ���պ�洢�����ݿ�
	private static final String DATABASE_ALARMLOG_TABLE = "alarmlog";// ������־�����ݿ�
	...
	public static final String  KEY_IS_SETTING_ALLOWED = "is_setting_allowed";
	...
	private static final String CREATE_STUDENT_TABLE = "create table "
			...
			+ " text not null," + KEY_PWD + " text, "+KEY_IS_SETTING_ALLOWED + " text);";
	...
	public long createCamera(String name, String did, String user, String pwd) {
		...
		initialValues.put(KEY_IS_SETTING_ALLOWED, "1");
		return db.insert(DATABASE_TABLE, null, initialValues);
	}
	
	public long createCamera(String name, String did, String user, String pwd,String isSettingAllowed) {
		ContentValues initialValues = new ContentValues();
		initialValues.put(KEY_NAME, name);
		initialValues.put(KEY_DID, did);
		initialValues.put(KEY_USER, user);
		initialValues.put(KEY_PWD, pwd);
		initialValues.put(KEY_IS_SETTING_ALLOWED, isSettingAllowed);
		return db.insert(DATABASE_TABLE, null, initialValues);
	}
	...
	public Cursor fetchAllCameras() {
		...
		return db.query(DATABASE_TABLE, new String[] { KEY_ID, KEY_NAME,
				KEY_DID, KEY_USER, KEY_PWD ,KEY_IS_SETTING_ALLOWED}, null, null, null, null, null);
		}catch(Exception ex){}
	...
	public int delAlarmLogAll(String did) {
		return db.delete(DATABASE_ALARMLOG_TABLE, KEY_DID+"= ?", new String[]{did});   
	}
