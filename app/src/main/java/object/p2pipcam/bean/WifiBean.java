...
public class WifiBean implements Serializable {
	...
	private int enable;
	private String ssid;
	private int wifi_link_status;
	public int getWifi_link_status() {
		return wifi_link_status;
	}

	public void setWifi_link_status(int wifi_link_status) {
		this.wifi_link_status = wifi_link_status;
	}
