...
public class AlermBean implements Serializable {
	...
	private int enable_alarm_audio;
	public int getEnable_alarm_audio() {
		return enable_alarm_audio;
	}

	public void setEnable_alarm_audio(int enable_alarm_audio) {
		this.enable_alarm_audio = enable_alarm_audio;
	}
