...
public class ViewRoomsGridViewAdapter extends BaseAdapter {
	...
	public ViewRoomsGridViewAdapter(Context context,View emptyView ,View listView) {
		...
		{
		   mRoomModelList=fetchRoomsFromDb(context);
		}
	...
	public void onItemClick(final View view,final int pos)
	{
		...
		view.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				...
				Intent intent = new Intent(context,RoomAndSwitchesTCPActivity.class);
	...
	public static List<Room_Model> fetchRoomsFromDb(Context mContex)
	{
