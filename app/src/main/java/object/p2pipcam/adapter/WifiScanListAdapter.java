...
public class WifiScanListAdapter extends BaseAdapter {
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		if (convertView == null) {
			...
			holder.wifi_scan_chanle = (TextView) convertView
					.findViewById(R.id.wifi_scan_chanle);
		...
		holder.signal.setText(Math.abs(wifiScanBean.getDbm0()) + "%");
		holder.wifi_scan_chanle.setText(wifiScanBean.getChannel()+"");
		String safeName = "";
