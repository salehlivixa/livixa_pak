...
//03-20 14:00:36.375: I/(25999): zhao-Command recv: enable_alarm_audio=0;
/***
 * 修改了jni库 视频数据播放逻辑---2014-04-03
 * ***/
public class ContentCommon {
	public static boolean viewAlpha=false;
	public static final int MSG_TYPE_START_SCAN_WIFI = 0x14;//0x3a;
	public static final int MSG_TYPE_GET_SCAN_WIFI = 0x3b;

	public static final String SDCARD_PATH = "IPcameraTEST";
	// public static final String SERVER_STRING =
	// "EJTDHXEHIASQARSTEIPAPHATLKASPDEKPNLNLTAUHUHXSULVEESVSWAOEHPKLULXARSTPGSQPDLNPEPALRPFLKLOLQLP-";
	//public static final String SERVER_STRING = "PFLXLNSULPLKAVLSHUHXEHSWEEARHWHZIHSXPGAOPESTPHSQLOPDLQPAHYEJEGERLRIALKEIIBEKHULNELICEEHXEHEM-$$";
	//public static final String SERVER_STRING = "AVTDHXIDAULKEHHYPLHUPFSWEEARTAPKPNSTPDPGAOLNHXEISQSXLPPAASEHLQLXARLUSULKLVPEHUSTHWHZEEIAPDIHPHIEAOIFESQLNENLRPALOEGEJERIBHYLKEIEPHUHXEKEEEHEOEL-$$";
	
	public static final String SERVER_STRING = "PFTDLREKSQHYEILVPAPDSYLNLKHXIBLTPNELAUHUASEHAVEESUARSWAOPELPLMLXSXPGSQLOPHLQPASTLRPILKPDLNLS-$$";

	public static final String APP_SOFTVERSION = "apa 4.5";
	public static final String APP_SOFTVERSION_SELF = "16.01.21.4.8";
	...
	public static final String STR_CAMERA_MODE = "cameramode";
	...
	public static final int PPPP_STATUS_INVALID_TIME = 9;
	...
	public static final int MSG_TYPE_GET_APP_VERSION = 0x38;
	...
	public static final int MSG_TYPE_GET_USER_TIME = 0x39;
