...
public class NativeCaller {
	...
	public native static int PPPPStartTalk(String did, int mode);
	...
	public native static int PPPPSDRecordSetting(String did,
			int record_audio_enable, int record_cover_enable, int record_timer,
			int record_size, int record_time_enable, int record_schedule_sun_0,
	...
	public native static int PPPPAlarmOpenCloseSetting(String did,
			int motion_armed, int input_armed);
	...
	public native static int DeletFile(String did, String name);

	public native static int PPPPSetUserTime(String did,
			int user_schedule_enable, int user_schedule_mode,
			int user_schedule_startday, int user_schedule_endday,
			int user_schedule_starttime_min, int user_schedule_endtime_min);
