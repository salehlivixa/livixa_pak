...
public class PlayActivity extends BaseActivity implements OnTouchListener,
	...
	private PopupWindow popupWindow_about, popupWindow_frame, popupWindow_re,
			popupWindow_in, popupWindow_bit;
	private Button buttonPreset;
	private View popv, popv_frame, popv_re, popv_infrared, popv_bit;
	...
	private Button button_frame1, button_frame2, button_frame3, button_frame4,
			button_frame5, button_frame6, ptz_frame;
	private int frame;
	private Button button_re1, button_re2, button_re3;
	private Button button_i1, button_i2;
...
final CustomAlertDialogueTwoButtons myASlertDialog=new CustomAlertDialogueTwoButtons(PlayActivity.this,getString(R.string.exit_play_show));
	...
	public void initExitPopupWindow_playMore() {
		...
		ptzHoriMirror2 = (ImageButton) popvPlayMore.findViewById(R.id.ptz_hori_mirror);
		ptzVertMirror2 = (ImageButton) popvPlayMore.findViewById(R.id.ptz_vert_mirror);
...
//			break;
		...
		case R.id.button_bit_1:
			...
			new AsyncTask<Void, Void, Void>() {
				...
				protected Void doInBackground(Void... arg0) {
					NativeCaller.PPPPCameraControl(strDID, 13, 200);
					try {
						Thread.sleep(300);
					} catch (InterruptedException e) {
						// TODO Auto-generated catch block
		...
		case R.id.button_bit_4:
			...
			new AsyncTask<Void, Void, Void>() {
				...
				@Override
				protected Void doInBackground(Void... arg0) {
					NativeCaller.PPPPCameraControl(strDID, 13, 2000);
					try {
						Thread.sleep(300);
					} catch (InterruptedException e) {
						// TODO Auto-generated catch block
	...
	public void callBaceVideoData(String did, byte[] videobuf, int h264Data,
		...
		if (isH264Data == 1) { // H264
			...
			isH264 = true;
//			if (maxFrameSize<videoDataLen)maxFrameSize=videoDataLen;
//			timeshow = "["+videoDataLen + " B]  ["+maxFrameSize/1000+" KB]  ["+nVideoWidth+"x"+nVideoHeight+"]";
			/*
			VideoYuvData vdata=new VideoYuvData();
			VideoYuvDataHead vhead=new VideoYuvDataHead();
			vhead.length=bufsize;
			vhead.height=height;
			vhead.width=width;
			vdata.head=vhead;
			vdata.data=videobuf;
			if (VideoYuvBuffer!=null)VideoYuvBuffer.addData(vdata);
			*/
			msg.what=1;
		} else { // MJPEG
