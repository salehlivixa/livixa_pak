...
import com.livixa.client.BridgeService.SDCardInterface;
...
public class SettingSDCardActivity extends BaseActivity implements
	...
	private Handler handler = new Handler() {
		public void handleMessage(android.os.Message msg) {
			...
			case PARAMS:
				...
				if (sdcardBean.getRecord_void_enable() == 1) {
				...
				spinner_start.setSelection(m_start_time);
				spinner_end.setSelection(m_end_time-1);
				break;
			default:
				break;
			}
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		WaitingStaticProgress.showProgressDialog(getString(R.string.sdcard_getparams), this);
	...
	private void findView() {
		...
		cbxVoid = (CheckBox) findViewById(R.id.cbx_void);
		...
		case R.id.set_sd_format:
			...
			new AsyncTask<Void, Void, Void>() {
				protected void onPreExecute() {
					...
					WaitingStaticProgress.showProgressDialog(getString(R.string.set_sd_format_show1), SettingSDCardActivity.this);
				};
	...
	private void setSDCardSchedule() {
		...
		NativeCaller.PPPPSDRecordSetting(strDID,
				sdcardBean.getRecord_void_enable(),
	...
	public void onCheckedChanged(CompoundButton v, boolean isChecked) {
		...
		case R.id.cbx_void:
			if (isChecked) {
				sdcardBean.setRecord_void_enable(1);
			} else {
				sdcardBean.setRecord_void_enable(0);
			}
			break;
	...
	private void get_start_and_end(int time1,int time2,int time3){
	    int hn[]=new int[3];
	...
	public void callBackRecordSchParams(String did, int record_cover_enable,
			...
			int record_void_enable, int record_schedule_sun_1,
		...
		sdcardBean.setRecord_void_enable(record_void_enable);
		sdcardBean.setRecord_sd_status(record_sd_status);
		sdcardBean.setSdtotal(sdtotal);
		sdcardBean.setSdfree(sdfree);
		get_start_and_end(record_schedule_mon_0,record_schedule_mon_1,record_schedule_mon_2);
