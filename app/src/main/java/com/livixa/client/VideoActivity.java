...
public class VideoActivity extends BaseActivity implements OnClickListener,
		OnItemClickListener {
	private TextView bntPhone;
	private TextView bntRemote;
	...
	private void findView() {
		...
		bntPhone = (TextView) findViewById(R.id.picture_phone);
		bntRemote = (TextView) findViewById(R.id.picture_remote);
	...
	public void onClick(View v) {
		...
		case R.id.picture_phone:
			...
			tag = 0;
			bntRemote.setBackgroundResource(R.drawable.camera_bg_rect_remote);
			bntPhone.setBackgroundResource(R.drawable.camera_bg_rect_local);
			mAdapter.setMode(mAdapter.PHONE);
			break;
		case R.id.picture_remote:
			tag = 1;
			bntRemote.setBackgroundResource(R.drawable.camera_bg_rect_local);
			bntPhone.setBackgroundResource(R.drawable.camera_bg_rect_remote);
	...
	public boolean onKeyDown(int keyCode, KeyEvent event) {
		if (keyCode == KeyEvent.KEYCODE_MENU) {
			...
			if (timeTag == 0) {
				...
				timeTag = 1;
				Toast.makeText(VideoActivity.this, R.string.main_show_back, 0)
						.show();
			} else if (timeTag == 1) {
				...
				if (timeTwo - timeOne <= 3) {
					...
					timeTag = 1;
					Toast.makeText(VideoActivity.this, R.string.main_show_back,
							0).show();
				}
			}
