...
import com.livixa.client.BridgeService.PlayBackInterface;
...
public class PlayBackActivity extends BaseActivity implements
	...
	private Handler mHandler = new Handler() {
		public void handleMessage(android.os.Message msg) {
			...
			case 2: {// jpeg
				...
				Bitmap bmp = null;
				try {
					bmp = BitmapFactory.decodeByteArray(videodata, 0,
							videoDataLen);
				} catch (Exception e) {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		audioPlayer = new AudioPlayer(AudioBuffer, 0);
	}
