...
public class ShResult implements Serializable 
{
	...
	@SerializedName("sh_sub_users")
	@Expose
	private ArrayList<_SubUser> sh_SubUsersList;
	
	
	
	

	public ArrayList<_SubUser>  getShsh_SubUsersList( ) {
		return sh_SubUsersList;
	}

	
	public void setShsh_SubUsersList(ArrayList<_SubUser> sh_SubUsersList) {
		
		
		this.sh_SubUsersList = sh_SubUsersList;
	}
