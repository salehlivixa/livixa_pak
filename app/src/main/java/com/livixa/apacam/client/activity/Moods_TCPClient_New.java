...
public class Moods_TCPClient_New {
    ...
    public Moods_TCPClient_New(OnMessageReceived listener,Context context) {
                ...
                while (mRun) {
                   ...
                   while(!end)
                   {
                    ...
                    if (serverMessage != null && mMessageListener != null) {
                    	...
                    	if(SwitchCommandManager.getCommandType(serverMessage).equals(SwitchCommandManager.READ_COMMAND))
                    	{
                    		try
                    		{
                    		stopTimmer();
