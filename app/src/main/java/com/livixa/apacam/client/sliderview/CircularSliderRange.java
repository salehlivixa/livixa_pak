package com.livixa.apacam.client.sliderview;
...
public class CircularSliderRange extends View {
    ...
    private void init(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        float startAngle = 0.0f;//a.getInt(R.styleable.HoloCircleSeekBar, 90);
        float endAngle = 90.00f;//a.getInt(R.styleable.HoloCircleSeekBar, 60);
    ...
    private void updateSliderState(int touchX, int touchY, Thumb thumb) {
        ...
        double fixedAngle = Math.toDegrees(mAngle);
